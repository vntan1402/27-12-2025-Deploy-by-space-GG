...
def test_apps_script_direct():
    ...
    create_payload = {
        ...
        "backend_api_url": "https://seacraft-portfolio.preview.emergentagent.com"
    }
    ...
    log_message("   💡 Backend API URL being sent: https://seacraft-portfolio.preview.emergentagent.com")
    
    # Test if the backend URL is accessible
    try:
        log_message("   🔍 Testing if backend URL is accessible...")
        backend_test = requests.get("https://seacraft-portfolio.preview.emergentagent.com/api/sidebar-structure", timeout=10)
