...
def test_apps_script_direct():
    ...
    create_payload = {
        ...
        "backend_api_url": "https://nautical-crew-hub.preview.emergentagent.com"
    }
    ...
    log_message("   💡 Backend API URL being sent: https://nautical-crew-hub.preview.emergentagent.com")
    
    # Test if the backend URL is accessible
    try:
        log_message("   🔍 Testing if backend URL is accessible...")
        backend_test = requests.get("https://nautical-crew-hub.preview.emergentagent.com/api/sidebar-structure", timeout=10)
