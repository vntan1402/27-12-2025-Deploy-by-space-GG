#!/usr/bin/env python3
"""
Clean up test data from Ship Management System MongoDB
...
async def cleanup_test_data():
    ...
    try:
        ...
        confirm = input("⚠️  Are you sure you want to delete ALL test data? (yes/no): ").lower().strip()
        if confirm != 'yes':
        ...
        # 2. Delete all ships (except keep system ships if needed)
...
def show_help():
    ...
    print("""
🧹 Ship Management System - Test Data Cleanup Tool

This script safely removes test data from MongoDB while preserving:
- Admin user accounts (admin, admin1)
...
❌ Ship survey status records
❌ Usage tracking records

DATA THAT WILL BE PRESERVED:
✅ Admin accounts (admin, admin1)
✅ Companies
✅ AI configuration
✅ System settings
...
Usage:
    ...
    python cleanup_test_data.py --help
    """)
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] in ['--help', '-h']:
        ...
        print("""
🧹 Ship Management System - Test Data Cleanup
=============================================""")
