...
export const AuditCertificateTable = ({
  ...
  // ⭐ Audit Certificates (ISM/ISPS/MLC): dueSoonDays = 90, status = "Due Soon"
            ...
            certificates.map((cert, index) => (
              ...
              >
                ...
                <td className="border border-gray-300 px-4 py-2">
                  {/* Certificate Type Badge Only - Category badges removed */}
                ...
                <td className="border border-gray-300 px-4 py-2">
                  ...
                  >
                    {getCertificateStatus(cert) === 'Valid' 
                      ...
                      : getCertificateStatus(cert) === 'Due Soon'
                      ? (language === 'vi' ? 'Sắp hết hạn' : 'Due Soon')
