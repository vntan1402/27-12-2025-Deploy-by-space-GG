    ...
    <div className="bg-blue-600 rounded-xl shadow-lg p-3 text-white flex flex-col" style={{ height: 'calc(100vh - 120px)', overflow: 'visible' }}>
      ...
      <div className="mt-3">
        <button
          ...
          className="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-3 rounded-lg transition-all text-sm font-medium flex items-center justify-center shadow-md"
        >
      ...
      <div className="mt-2">
        <button
          onClick={() => navigate('/')}
          className="w-full bg-blue-700 hover:bg-blue-800 text-white py-2 px-3 rounded-lg transition-all text-sm font-medium flex items-center justify-center shadow-md"
        >
          <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
      ...
      {/* Bottom Actions */}
      <div className="mt-4 pt-3 border-t border-blue-500 space-y-2">
        {canAccessSettings && (
          <button
            onClick={handleSystemSettings}
            className="w-full bg-blue-700 hover:bg-blue-800 text-white py-1.5 px-3 rounded-lg transition-all text-xs font-medium flex items-center justify-center"
          >
        ...
        <button
          ...
          className="w-full bg-red-600 hover:bg-red-700 text-white py-1.5 px-3 rounded-lg transition-all text-xs font-medium flex items-center justify-center"
        >
