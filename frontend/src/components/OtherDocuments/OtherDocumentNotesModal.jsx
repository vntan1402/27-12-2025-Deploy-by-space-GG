...
const OtherDocumentNotesModal = ({ show, onClose, document, onUpdate }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      setIsSaving(true);
      await otherDocumentService.update(document.id, { note });
...
export default OtherDocumentNotesModal;
