/**
 * Edit Approval Document Modal
 * Simple edit form for approval document metadata
 */
...
export const EditApprovalDocumentModal = ({ isOpen, onClose, document, onDocumentUpdated }) => {
  ...
  useEffect(() => {
    if (document) {
      setFormData({
        approval_document_name: document.approval_document_name || '',
        approval_document_no: document.approval_document_no || '',
      ...
      <div className="bg-white rounded-xl shadow-2xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-bold text-gray-800">
            {language === 'vi' ? '✏️ Chỉnh sửa Tài liệu Phê duyệt' : '✏️ Edit Approval Document'}
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              placeholder={language === 'vi' ? 'VD: ISM Code Compliance Certificate' : 'e.g. ISM Code Compliance Certificate'}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm"
                placeholder={language === 'vi' ? 'VD: ISM-2024-001' : 'e.g. ISM-2024-001'}
              />
            </div>
