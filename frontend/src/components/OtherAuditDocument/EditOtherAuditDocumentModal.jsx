/**
 * Edit Other Audit Document Modal
...
const EditOtherAuditDocumentModal = ({ show, onClose, document, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await otherAuditDocumentService.update(document.id, {
...
export default EditOtherAuditDocumentModal;
