/**
 * Batch Processing Modal for Crew Passports
 * Shows progress for multiple passport files being processed
 * Matches Test Report style with minimize feature and individual file progress
 */
        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-500 to-blue-600 flex justify-between items-center">
          <div className="text-white">
            <h3 className="text-lg font-bold">
              {language === 'vi' ? '📤 Xử lý hàng loạt Passports' : '📤 Batch Processing Passports'}
            </h3>
          ...
          <div className="p-6 overflow-y-auto max-h-[60vh]">
            ...
            <div className="mb-6">
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>{language === 'vi' ? 'Tiến độ tổng' : 'Overall Progress'}</span>
                <span>{Math.round((progress.current / progress.total) * 100)}%</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-blue-500 to-green-500 h-4 rounded-full transition-all duration-500 flex items-center justify-center text-xs text-white font-semibold"
