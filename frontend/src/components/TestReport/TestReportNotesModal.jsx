...
export const TestReportNotesModal = ({ isOpen, onClose, report, onNoteUpdated }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      await testReportService.update(report.id, {
        note: note.trim() || null
      });
