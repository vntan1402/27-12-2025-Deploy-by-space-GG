/**
 * Ship Management System - Fixed Apps Script v3.5
 * With Proper Error Handling for Move and Delete Operations
 */
...
function handleRequest(e) {
  try {
    ...
    if (e && e.postData && e.postData.contents) {
      ...
      return createJsonResponse(true, "Ship Management Apps Script v3.5 is WORKING!", {
        version: "3.5-fixed-move-delete-operations",
        ...
        fixes: [
          ...
          "Added proper try-catch blocks for file operations",
          "Enhanced move_file with proper folder access validation",
          "Optimized get_folder_structure performance"
        ]
      });
    }
...
/**
 * Get dynamic folder structure from backend API
 */
