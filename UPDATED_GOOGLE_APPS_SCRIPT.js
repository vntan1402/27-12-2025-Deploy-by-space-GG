/**
 * Ship Management System - Clean Apps Script v3.2 
 * Multi Cert Upload with Move Functionality Added
 */
...
function handleRequest(e) {
  try {
    ...
    if (e && e.postData && e.postData.contents) {
      ...
      return createJsonResponse(true, "Ship Management Apps Script v3.2 is WORKING!", {
        version: "3.2-with-move-functionality",
...
// NEW FUNCTION: Get folder structure for Move functionality
...
// NEW FUNCTION: Move file between folders
