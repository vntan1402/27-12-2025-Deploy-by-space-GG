...
{{
  ...
  "cert_type": "Certificate type - MUST be EXACTLY ONE of these 7 options: 'Full Term', 'Interim', 'Provisional', 'Short term', 'Conditional', 'Statement', 'Other'. IMPORTANT: If cert_name contains 'INTERIM', use 'Interim'. If cert_name contains 'STATEMENT' (but NOT 'INTERIM'), use 'Statement'. Look for keywords: 'Full Term' (standard long-validity certificate), 'Interim' (temporary/between surveys), 'Provisional' (pending full certification), 'Short term' (limited validity), 'Conditional' (with conditions), 'Statement' (Statement of Compliance, Statement of Fact). Default to 'Full Term' if not explicitly stated.",
