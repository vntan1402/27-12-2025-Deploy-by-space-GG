...
async def get_upcoming_surveys(current_user: UserResponse = Depends(get_current_user)):
    ...
    try:
        ...
        return {
            ...
            "logic_info": {
                "description": "Each certificate creates its own survey window based on Next Survey rules. Current date must fall within certificate's window.",
                "window_rules": {
...
async def create_dynamic_ship_folder_structure(gdrive_config: dict, ship_name: str, company_id: str) -> dict:
    ...
    try:
        ...
        backend_api_url = os.environ.get('BACKEND_API_URL', 'https://vesseltrack.preview.emergentagent.com')
