...
async def get_certificate_form_fields_for_extraction():
    ...
    try:
        ...
        cert_fields = {
            ...
            "keel_laid": "Date on which keel was laid (look for 'Date on which keel was laid or ship was at similar stage of construction', format as YYYY-MM-DD, example: MAY 04, 2018 → 2018-05-04)",
...
async def create_dynamic_ship_folder_structure(gdrive_config: dict, ship_name: str, company_id: str) -> dict:
    ...
    try:
        ...
        backend_api_url = os.environ.get('BACKEND_API_URL', 'https://nautical-certs-1.preview.emergentagent.com')
