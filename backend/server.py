...
async def get_ship_form_fields_for_extraction() -> dict:
    ...
    try:
        ...
        ship_fields = {
            ...
            "ship_type": "Type of vessel - Look for the ship type section that shows different options (like checkboxes or list). Find which option is SELECTED/MARKED/CHECKED (usually indicated by 'X', checkmark, or other marking). Common form structure shows multiple options like 'Bulk Carrier', 'Gas Carrier', 'Cargo ship other than any of the previous', etc. Extract the SELECTED option and convert to standard format: if 'Cargo ship other than any of the previous' is selected, return 'General Cargo'.",
